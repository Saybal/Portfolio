...
const Navbar = () => {
  ...
  const link = (
    <>
      <li className="body-font font-semibold mx-3 text-base-content text-lg cursor-pointer">
      ...
      <li className="block body-font font-semibold mx-3 text-base-content text-lg cursor-pointer">
  ...
  return (
    <div className={`navbar bg-base-100 shadow-sm sticky top-0 z-50 ${currentTheme === 'sunset' ? "border-b-1 border-white/15" : ""}`}>
